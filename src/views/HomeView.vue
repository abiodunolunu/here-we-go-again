...
<template>
  <main class="grid gap-10">
    <section class="">
      <h1
        class="text-4xl sm:text-6xl font-bold glitch text-black font-mono my-2"
        data-text="I'm Abiodun Olunu"
        id="name"
      >
        I'm Abiodun Olunu
      </h1>
    ...
    <modal v-model="showContactModal">
      <contact-details />
    </modal>
  </main>
</template>
...
.my-name {
  animation: expand 5000ms ease-in-out ease-in-out;
}
